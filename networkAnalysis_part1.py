...
with arcpy.da.SearchCursor("Network_within_city.gdb/City_zone_AB_4326", ['GEONAME']) as cursor:
    for row in cursor:
...
def main():
    ...
    for ct in city_name_ls:
        ...
        arcpy.management.MakeFeatureLayer(zone_cent_path, zone_cent_layer, "REGION = {}".format(ct))
